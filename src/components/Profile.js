    ...
    <Fragment>
        <Row className="justify-content-center">
            <Col md={8} sm={12} className="d-flex justify-content-between img-column">
                ...
                <MdEdit size={10} className=" center rounded-edit " onClick={handleShow}></MdEdit>
            </Col>
        </Row>
        <Row className="justify-content-center mt-2">
            ...
            <Col md={4} sm={6} className="d-flex flex-wrap">
                <p className="p-1 m-0" onClick={()=>handleAlertShow("LinkedIn Profile",profile.linkedin)}><BsLinkedin size={30} className="p-1"/>{profile.linkedin}</p>
