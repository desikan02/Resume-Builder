...
function Project() {
  ...
  const {addProject, removeSkill} = bindActionCreators(actionCreators, dispatch);
        ...
        <Modal.Body>
          <Form noValidate validated={validated} className="d-flex align-item-start mb-2" onSubmit={handleproject}>
            <Form.Group className="">
              <Form.Control required type="text" size="sm" placeholder="Enter Project" value={input} onChange={handleInput} />
            </Form.Group>
